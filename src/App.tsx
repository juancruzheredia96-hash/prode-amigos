...
const MARFIL = "#ffffff";
const BORDO = "#74acdf";
const BORDO_LIGHT = "#5b9fd4";
const BORDO_DARK = "#2d7bb8";
const MARFIL_DARK = "#c8dff0";
const MARFIL_LIGHT = "#eaf4fc";
const VERDE = "#2e7d32";
      ...
      <div style={{ width:"100%", maxWidth:600, background:"white", height:"100vh",
        ...
        <div style={{ background:BORDO, padding:"10px 16px 12px",
          ...
          <div style={{ display:"flex", flexDirection:"column", justifyContent:"center", gap:3 }}>
            <div style={{ color:MARFIL, fontSize:15, fontWeight:600 }}>El PRODE</div>
